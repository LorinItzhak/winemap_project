...
struct NewReportView: View {
  ...
  var body: some View {
    NavigationView {
      ZStack {
        Color(.systemGray6).ignoresSafeArea()  // במקום BackgroundGray
            ...
            ZStack(alignment: .center) {
              if let uiImage = selectedImage {
                ...
                RoundedRectangle(cornerRadius: 12)
                    ...
                    .overlay(
                      RoundedRectangle(cornerRadius: 12)
                          .stroke(Color(red: 0.545, green: 0.0, blue: 0.0).opacity(0.3), lineWidth: 2)
                    )
                    .overlay(
                      VStack(spacing: 12) {
            ...
            VStack(spacing: 16) {
                  ...
                  ForEach(1...5, id: \.self) { index in
                    Button {
                      ...
                      Image(systemName: index <= rating ? "star.fill" : "star")
                          .font(.title2)
                          .foregroundColor(index <= rating ? Color(red: 1.0, green: 0.843, blue: 0.0) : Color.gray)
                    }
                  }
              ...
              VStack(alignment: .leading, spacing: 12) {
                ...
                Button {
                  ...
                  .overlay(
                    RoundedRectangle(cornerRadius: 8)
                        .stroke(Color(red: 0.545, green: 0.0, blue: 0.0), lineWidth: 1)
                  )
                  .cornerRadius(8)
                }
            ...
            Button {
              ...
              .background(
                isFormValid() && !isUploading ?
                  Color(red: 0.545, green: 0.0, blue: 0.0) :
                  Color(red: 0.545, green: 0.0, blue: 0.0).opacity(0.4)
              )
              .cornerRadius(12)
            }
