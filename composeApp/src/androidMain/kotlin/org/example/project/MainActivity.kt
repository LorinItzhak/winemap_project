...
// 🎯 הוספה חדשה - import עבור LocalReportRepositoryImpl
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 🎯 הוספה חדשה - אתחול הדאטאבייס המקומי
        try {
            ...
            MaterialTheme {
                ...
                Scaffold(
                    ...
                    NavHost(
                        ...
                        // 4) feed - 🎯 שינוי כאן!
                        composable("feed") {
                            // 🎯 שינוי: משתמש ב-LocalReportRepositoryImpl במקום ב-ReportRepositoryImpl
                        ...
                        // 6) new wine review - 🎯 שינוי כאן!
                        composable("new-report") {
                            // 🎯 שינוי: משתמש ב-LocalReportRepositoryImpl
                            val reportVm = remember { ReportViewModel(LocalReportRepositoryImpl()) }
                        ...
                        // 8) wine review details - 🎯 שינוי כאן!
